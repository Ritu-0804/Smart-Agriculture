...
import { FaLeaf, FaSeedling, FaCloudSun, FaBug, FaFlask, FaArrowRight } from "react-icons/fa";
...
const features = [
  ...
  },
  {
    ...
    desc: "Upload plant images to detect diseases instantly with deep learning models.",
    ...
    <div style={{
      ...
      <section className="hero-section">
        ...
        <motion.div className="hero-cta" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
          <Link to="/soil" className="btn-primary">
            Analyze Soil <FaArrowRight />
          </Link>
          <Link to="/weather" className="btn-secondary">
          ...
          {features.map((f, i) => (
            ...
            >
              <Link to={f.to} className="feature-card" style={{ "--glow": f.glow }}>
                <div className="feature-icon" style={{ background: f.glow, color: f.color }}>
                  {f.icon}
                </div>
